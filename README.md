...
Tên thư mục phải trùng với `name`. Dòng `description` quyết định agent có nhận
ra để đọc hay không, nên viết rõ cả việc lẫn từ khoá kích hoạt. Chạy lại script
cài là xong.
...
Hoàng Ngọc Vương, CÔNG TY TNHH VUTEX, Đà Nẵng
